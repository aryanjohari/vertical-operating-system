                ...
                {leads.length === 0 ? (
                  ...
                  leads.map((lead) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-muted-foreground max-w-[180px] truncate" title={lead.metadata?.page_path ?? (lead.metadata?.data as Record<string, unknown> | undefined)?.page_path ?? ""}>
