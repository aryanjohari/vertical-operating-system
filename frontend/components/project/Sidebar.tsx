...
export default function Sidebar({ projectId }: SidebarProps) {
  ...
  const campaignQs = firstCampaignId
    ? `?campaign=${encodeURIComponent(firstCampaignId)}`
    : "";

  const navItems = [
    {
      name: "Dashboard",
      href: `/projects/${projectId}${campaignQs}`,
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
    ...
    {
      name: "Intel",
      href: `/projects/${projectId}/pseo/intel${campaignQs}`,
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
    ...
    {
      name: "Strategy",
      href: `/projects/${projectId}/pseo/strategy${campaignQs}`,
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
    ...
    {
      name: "Quality",
      href: `/projects/${projectId}/pseo/quality${campaignQs}`,
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
